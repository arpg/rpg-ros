...
#ifndef _jaguar_base_h_
#define _jaguar_base_h_
 ...
 */
  ...
  public:
    ...
    /*! @brief
     *  This function will use struct MotionConfig to configure the driver
     * @param[in]   driverConfig struct MotionConfig
     * @return null
     */
    void setMotionDriverConfig(MotionConfig* driverConfig);

    /*! @brief
    *  This function will return the configuration of the driver
    * @param[in]   driverConfig struct MotionConfig, will contain the driver configuration
    * @return null
    */
    void getMotionDriverConfig(MotionConfig* driverConfig);
    ...
    /* Same idea as disable, but enables a channel for commands */

    int enableMotorCmd(const int channel);
    /*! @brief
